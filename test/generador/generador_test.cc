...
TEST(GenerarContraTest, LetrasYNumeros) {
    std::string contra = Generador::GenerarContra(40, Generador::TipoContra::ALFA_NUM);
...
TEST(GenerarContraTest, MayusculasYNumeros) {
    std::string contra = Generador::GenerarContra(40, Generador::TipoContra::ALFA_NUM_MAY);
...
TEST(GenerarContraTest, MinusculasYNumeros) {
    std::string contra = Generador::GenerarContra(40, Generador::TipoContra::ALFA_NUM_MIN);
    EXPECT_TRUE(std::regex_match(contra, std::regex("^[a-z0-9]+$")));
}